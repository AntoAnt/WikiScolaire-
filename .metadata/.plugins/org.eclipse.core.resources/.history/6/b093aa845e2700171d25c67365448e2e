...
<body>
<table>
	<tr>Bienvenue sur WikiScolaire!</tr>
	...
	<tr><td><a href ="/InterfaceWikiScolair/Recherche.jsp"><input type="button" name="Recherche_cours" value="Rechercher"></a>
		<tr><td>Vous pouvez Ajouter des cours de <%out.println(session.getAttribute("niv"));%> </td></tr>
	<tr><td><a href ="/InterfaceWikiScolair/AjoutCours.jsp"><input type="button" name="Ajout_cours" value="Ajout"></a>
</table>
