...
<table>
	...
	<form method="post" action="/InterfaceWikiScolair/ControleurPrincipal?idaction=Redirect_Recherche_Cours_admin">
	...
	<form method="post" action="/InterfaceWikiScolair/ControleurPrincipal?idaction=Redirect_Ajout_Cours_admin">
