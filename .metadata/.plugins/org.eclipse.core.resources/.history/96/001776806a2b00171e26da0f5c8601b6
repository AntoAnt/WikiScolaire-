...
<table>
	...
	<tr><td>Vous pouvez trouver des cours de <%out.println(session.getAttribute("niv"));%> </td></tr>
	<form method="post" action="/InterfaceWikiScolair/ControleurPrincipal?idaction=Redirect_Recherche_Cours">
		<tr><td><input type="submit" name="Redirect_Recherche_Cours" value="Recherche"></a></td></tr>
	</form>
