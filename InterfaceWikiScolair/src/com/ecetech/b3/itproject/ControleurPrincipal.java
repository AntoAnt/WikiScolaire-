...
=======
			System.out.println("erreur idaction non trouvÈ");
...
<<<<<<< HEAD
					...
					admin a = adminDAO.getadminbyiduser(u.getId_user());
			          ...
			          if (a.getNiv_admin() == 2){
			            ...
			            // crÔøΩation d'une session utilisateur ...
			            //HttpSession session = request.getSession();
			            ...
			            // forward vers la page d'acceuil aprÔøΩs authentification
...
=======
				...
				admin a = adminDAO.getadminbyiduser(u.getId_user());
					...
					if (a.getNiv_admin() == 2){
						...
						System.out.println("Ok Creation de la session admin");
						// crÈation d'une session utilisateur ...
						//HttpSession session = request.getSession();
						session.setAttribute( "login", u.getLogin() );
						session.setAttribute("id", u.getId_user());
						session.setAttribute("niv", u.getNiveau());
						...
						// forward vers la page d'acceuil aprËs authentification
						this.getServletContext().getRequestDispatcher("/WEB-INF/accueil_admin.jsp").forward( request, response );
...
>>>>>>> gerobranche
													...
													//selon le code ... retourner le rÈsultat de l'opÈration ... utilisateur ajoutÈ avec succËs;
...
<<<<<<< HEAD
				...
				{
					/* r√©cup√©rer les informations de la requete, faire appelle √† une fonction DAO
